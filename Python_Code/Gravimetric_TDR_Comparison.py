...
r_R_sq_CSP3_CRNSDistance = round(R_sq_CSP3_CRNSDistance, 2)
...
#import spreadsheet
GWC_CSP1_weighted = pd.read_csv('YOUR PATHs/2023_CSP1_SWC_depth_weighted.csv', parse_dates= ['DATE'], index_col=['DATE'],na_values=['-9999'])
...
r_R_sq_CSP3_23 = round(R_sq_CSP3_23, 2)
...
############## CSP1 ##############
plt.scatter(x_CSP1_23, y_CSP1_23, color = 'magenta', marker ='X', label = 'TDR')
plt.plot(x_CSP1_23, alpha_CSP1_23[0]*x_CSP1_23 + alpha_CSP1_23[1], color = 'magenta', linestyle = 'solid')

a_CSP1_1, b_CSP1_1 = np.polyfit(x_CSP1,y_CSP1,1)
plt.scatter(x_CSP1, y_CSP1, marker='o', color='red', label='Gravimetric\nNon-Weighted')
plt.plot(x_CSP1, a_CSP1_1*x_CSP1+b_CSP1_1, linestyle = '-', color = 'red')

a_CSP1_1_weighted, b_CSP1_1_weighted = np.polyfit(x_CSP1_weighted,y_CSP1_weighted,1)
plt.scatter(x_CSP1_weighted, y_CSP1_weighted, marker='^', color='green', label = 'Gravimetric\n10cm, 25cm\nWeighted')
plt.plot(x_CSP1_weighted, a_CSP1_1_weighted*x_CSP1_weighted+b_CSP1_1_weighted, linestyle = '-', color = 'green')

a_CSP1_1_weighted_schron, b_CSP1_1_weighted_schron = np.polyfit(x_CSP1_weighted_schron,y_CSP1_weighted_schron,1)
plt.scatter(x_CSP1_weighted_schron, y_CSP1_weighted_schron, marker='s', color='blue', label = 'Gravimetric\nSchrön Weighted')
...
row_labels = ['Arithmetic Average', '10cm,25cm Depth Weighted', 'Schrön Depth Weighted', 'TDR']

table_vals = [[r_mm_CSP1, r_nn_CSP1,r_R_sq_CSP1], [r_mm_CSP1_weighted, r_nn_CSP1_weighted, r_R_sq_CSP1_weighted], [r_mm_CSP1_weighted_schron, r_nn_CSP1_weighted_schron, r_R_sq_CSP1_weighted_schron], [r_mm_CSP1_23, r_nn_CSP1_23, r_R_sq_CSP1_23]]
...
plt.title('CSP1 Gravimetric and TDR Comparison 2023')
plt.legend(bbox_to_anchor=(1.005,1), loc = 'upper left', borderaxespad=0, fontsize = '7.75')
plt.gca().set_axisbelow(True)
plt.grid(which='major', zorder=-1.0, alpha=0.5)
plt.ylim(2500,3100)
plt.savefig('YOUR PATH TO SAVE/CSP1_Grav_TDR_Compare.png', dpi=300, bbox_inches='tight')
plt.show()

############## CSP2 ##############
plt.scatter(x_CSP2_23, y_CSP2_23, color = 'magenta', marker = 'X', label = 'TDR')
plt.plot(x_CSP2_23, alpha_CSP2_23[0]*x_CSP2_23 + alpha_CSP2_23[1], color = 'magenta', linestyle = 'solid')

a_CSP2_1, b_CSP2_1 = np.polyfit(x_CSP2,y_CSP2,1)
plt.scatter(x_CSP2, y_CSP2, marker='o', color='red', label = 'Gravimetric\nNon-Weighted')
plt.plot(x_CSP2, a_CSP2_1*x_CSP2+b_CSP2_1, linestyle = '-', color = 'red')

a_CSP2_1_weighted, b_CSP2_1_weighted = np.polyfit(x_CSP2_weighted,y_CSP2_weighted,1)
plt.scatter(x_CSP2_weighted, y_CSP2_weighted, marker='^', color='green', label = 'Gravimetric\n10cm, 25cm\nWeighted')
plt.plot(x_CSP2_weighted, a_CSP2_1_weighted*x_CSP2_weighted+b_CSP2_1_weighted, linestyle = '-', color = 'green')

a_CSP2_1_weighted_schron, b_CSP2_1_weighted_schron = np.polyfit(x_CSP2_weighted_schron,y_CSP2_weighted_schron,1)
plt.scatter(x_CSP2_weighted_schron, y_CSP2_weighted_schron, marker='s', color='blue', label = 'Gravimetric\nSchrön Weighted')
...
table_vals = [[r_mm_CSP2, r_nn_CSP2,r_R_sq_CSP2], [r_mm_CSP2_weighted, r_nn_CSP2_weighted, r_R_sq_CSP2_weighted], [r_mm_CSP2_weighted_schron, r_nn_CSP2_weighted_schron, r_R_sq_CSP2_weighted_schron], [r_mm_CSP2_23, r_nn_CSP2_23, r_R_sq_CSP2_23]]
table = plt.table(cellText=table_vals,
                       colWidths=[0.1] * 3,
                       rowLabels=row_labels,
                       colLabels=col_labels,
...
plt.xlabel('BWE (mm)')
plt.ylabel(r'$N_{0}$ (cph)')
plt.title('CSP2 Gravimetric and TDR Comparison 2023')
plt.legend(bbox_to_anchor=(1.005,1), loc = 'upper left', borderaxespad=0, fontsize = '7.75')
plt.gca().set_axisbelow(True)
plt.grid(which='major', zorder=-1.0, alpha=0.5)
plt.ylim(2500,3100)
plt.savefig('YOUR PATH TO SAVE/CSP2_Grav_TDR_Compare.png', dpi=300, bbox_inches='tight')
plt.show()

############## CSP3 ##############
plt.scatter(x_CSP3_23, y_CSP3_23, color = 'magenta', marker = 'X', label = 'TDR')
plt.plot(x_CSP3_23, alpha_CSP3_23[0]*x_CSP3_23 + alpha_CSP3_23[1], color = 'magenta', linestyle = 'solid')

a_CSP3_1_CRNSDistance, b_CSP3_1_CRNSDistance = np.polyfit(x_CSP3_CRNSDistance,y_CSP3_CRNSDistance,1)
plt.scatter(x_CSP3_CRNSDistance, y_CSP3_CRNSDistance, marker='o', color='red', label = 'Gravimetric\nNon-Weighted')
plt.plot(x_CSP3_CRNSDistance, a_CSP3_1_CRNSDistance*x_CSP3_CRNSDistance+b_CSP3_1_CRNSDistance, linestyle = '-', color = 'red')
...
plt.scatter(x_CSP3_weighted_CRNSDistance, y_CSP3_weighted_CRNSDistance, marker='^', color='green', label = 'Gravimetric\n10cm, 25cm\nWeighted')
plt.plot(x_CSP3_weighted_CRNSDistance, a_CSP3_1_weighted_CRNSDistance*x_CSP3_weighted_CRNSDistance+b_CSP3_1_weighted_CRNSDistance, linestyle = '-', color = 'green')

a_CSP3_1_weighted_schron, b_CSP3_1_weighted_schron = np.polyfit(x_CSP3_weighted_schron,y_CSP3_weighted_schron,1)
plt.scatter(x_CSP3_weighted_schron, y_CSP3_weighted_schron, marker='s', color='blue', label = 'Gravimetric\nSchrön Weighted')
...
table_vals = [[r_mm_CSP3_CRNSDistance, r_nn_CSP3_CRNSDistance,r_R_sq_CSP3_CRNSDistance], [r_mm_CSP3_weighted_CRNSDistance, r_nn_CSP3_weighted_CRNSDistance, r_R_sq_CSP3_weighted_CRNSDistance],[r_mm_CSP3_weighted_schron, r_nn_CSP3_weighted_schron, r_R_sq_CSP3_weighted_schron], [r_mm_CSP3_23, r_nn_CSP3_23, r_R_sq_CSP3_23]]
table = plt.table(cellText=table_vals,
                       colWidths=[0.1] * 3,
                       rowLabels=row_labels,
                       colLabels=col_labels,
...
plt.xlabel('BWE (mm)')
plt.ylabel(r'$N_{0}$ (cph)')
plt.title('CSP3 Gravimetric and TDR Comparison 2023')
plt.legend(bbox_to_anchor=(1.005,1), loc = 'upper left', borderaxespad=0, fontsize = '7.75')
plt.gca().set_axisbelow(True)
plt.grid(which='major', zorder=-1.0, alpha=0.5)
plt.savefig('YOUR PATH TO SAVE/CSP3_Grav_TDR_Compare.png', dpi=300, bbox_inches='tight')
plt.show()
...
col_labels = ['Slope', 'Intercept', 'r\u00b2']
row_labels = ['Arithmetic Average', 'Schrön Depth Weighted', 'TDR']

table_vals = [[r_mm_CSP1, r_nn_CSP1,r_R_sq_CSP1], [r_mm_CSP1_weighted_schron, r_nn_CSP1_weighted_schron, r_R_sq_CSP1_weighted_schron], [r_mm_CSP1_23, r_nn_CSP1_23, r_R_sq_CSP1_23]]
table = plt.table(cellText=table_vals,
                       colWidths=[0.1] * 3,
                       rowLabels=row_labels,
                       colLabels=col_labels,
...
table_vals = [[r_mm_CSP2, r_nn_CSP2,r_R_sq_CSP2], [r_mm_CSP2_weighted_schron, r_nn_CSP2_weighted_schron, r_R_sq_CSP2_weighted_schron], [r_mm_CSP2_23, r_nn_CSP2_23, r_R_sq_CSP2_23]]
table = plt.table(cellText=table_vals,
                       colWidths=[0.1] * 3,
                       rowLabels=row_labels,
                       colLabels=col_labels,
...
table_vals = [[r_mm_CSP3_CRNSDistance, r_nn_CSP3_CRNSDistance,r_R_sq_CSP3_CRNSDistance],[r_mm_CSP3_weighted_schron, r_nn_CSP3_weighted_schron, r_R_sq_CSP3_weighted_schron], [r_mm_CSP3_23, r_nn_CSP3_23, r_R_sq_CSP3_23]]
table = plt.table(cellText=table_vals,
                       colWidths=[0.1] * 3,
                       rowLabels=row_labels,
                       colLabels=col_labels,
